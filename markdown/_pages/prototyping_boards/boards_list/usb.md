...
<p class="cust_indent" markdown="1"><img height="150" src="/_assets/img/usb-module.png"></p>
...
The USB board power-delivery in the Luos network is limited to `500 mA`. This board can’t power too many boards and power-demanding ones like, for example, a DC-motor board with one or two motors connected. If you experiment power issues, feel free to add a power category board like a [Jack power input board](/_pages/prototyping_boards/boards_list/jack-power-input.md).

<div class="cust_edit_page"><a href="https://github.com/Luos-io/doc/src/_pages/prototyping_boards/boards_list/usb.md">Edit this page</a></div>
